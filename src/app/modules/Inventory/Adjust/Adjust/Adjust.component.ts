...
export class AdjustComponent implements OnInit {
  ...
  headerCard: string = "บันทึกปรับปรุงสินค้า";
  ...
  private async ShowModal() {
    if (this.document.BrnCodeFrom != null) {
      ...
      let modalResponseData = await this.SvDefault.ShowModalAsync<ModelInvAdjustRequestHd>(AdjustModalComponent, "lg", modalParam);
