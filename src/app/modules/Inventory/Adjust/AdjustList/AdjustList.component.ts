...
@Component({
    selector: 'app-AdjustList',
    templateUrl: './AdjustList.component.html',
    styleUrls: ['./AdjustList.component.scss']
})
...
export class AdjustListComponent implements OnInit {
    ...
    navigateToProfile(id) {
        this.router.navigate(['/Adjust/' + id], { relativeTo: this.activatedRoute });
    }
