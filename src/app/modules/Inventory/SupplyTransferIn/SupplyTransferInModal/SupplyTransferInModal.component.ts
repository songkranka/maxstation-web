...
@Component({
  selector: 'app-SupplyTransferInModal',
  templateUrl: './SupplyTransferInModal.component.html',
  styleUrls: ['./SupplyTransferInModal.component.scss']
})
export class SupplyTransferInModalComponent implements OnInit {
