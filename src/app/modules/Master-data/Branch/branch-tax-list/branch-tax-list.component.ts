...
@Component({
  selector: 'app-branch-tax-list',
  templateUrl: './branch-tax-list.component.html',
  styleUrls: ['./branch-tax-list.component.scss']
})
export class BranchTaxListComponent implements OnInit {
  ...
  private async NewDocument(){
    this._router.navigate(['/BranchTax/New']);
  }
