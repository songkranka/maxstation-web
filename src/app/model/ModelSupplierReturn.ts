...
export class GetSupplierReturnHdListQueryResource{
    keyword : string = "";
    compCode : string = "";
    brnCodeTo : string = "";
}

export class ModelSupplierReturnHeader{
    compCode : string = "";
    brnCode : string = "";
    locCode : string = "";
    docNo : string = "";
    ...
    //------------------[ Extra Field ]-----------------//
    listTransferInDetail : ModelSupplierReturnDetail[] = [];
}

export class ModelSupplierReturnDetail{
    compCode : string = "";
    brnCode : string = "";
    locId : string = "";
    docNo : string = "";
...
export class ModelSearchSupplierReQueryResource{
    compCode : string = "";
    brnCode : string = "";
    locCode : string = "";
    guid : string = "";
